...
def get_fb_post(request):
    ...
    data = {'friend_posts': found_post, 'picture': 'https://graph.facebook.com/{0}/picture?type=large'.format(friend_id), 'name': 'https://graph.facebook.com/{0}/name?'.format(friend_id)}
